...
---
# <a name="archived-release-notes-for-monthly-enterprise-channel"></a>Notes de versions archivées pour le canal entreprise mensuel
Ces notes de version fournissent des informations sur de nouvelles fonctionnalités et les mises à jour non relatives à la sécurité incluses dans les mises à jour du canal entreprise mensuel à Office 365 ProPlus, Visio Pro pour Office 365, le Client de bureau Project Online et Office 365 Business.
...
- **Amélioration des liens dans les e-mails :** lorsque vous incluez un lien vers un fichier, le nom du fichier remplace l’URL. Vous pouvez modifier les autorisations afin que tous les destinataires aient accès.
...
- Nous avons corrigé un problème à l’origine du retour de recherche sans résultat lors de la recherche de calendriers partagés non mis en cache.
...
- Nous avons résolu un problème qui désactivait les protections IRM lors de l’ouverture d’un fichier PowerPoint en mode protégé.
...
- Nous avons résolu un problème avec la boîte de dialogue Compresser l’image qui ne conservait pas certains paramètres utilisateur.


- Nous avons résolu un problème dans lequel Point de terminaison protection contre la perte de données Microsoft 365 n’a pas pu classifier des documents Office sur disque.


- Lorsque l’utilisateur imprime un document/fichier sur des imprimantes à jet d’encre à partir d’Office et que l’encre est faible, le message « Toner faible » ou « Aucun toner » s’affiche, même si les imprimantes à jet d’encre n’ont pas de toner. Modification du message pour afficher « Toner/encre faible » et « Aucun toner/encre ».
...
- **Nouvelle carte de visite pour Outlook :** nouvelle carte de visite pour Outlook comprenant une meilleure vue de l'organisation et correspondant au style de carte d'Outlook Web. [En savoir plus](https://support.office.com/article/e80f931f-5fc4-4a59-ba6e-c1e35a85b501)
...
- Correction d’un problème à cause duquel Excel pouvait se bloquer dans certaines circonstances lors de l’utilisation de Reproduire la mise en forme.
...
- Résolution d’un problème qui empêchait l’affichage du menu contextuel avec clic droit dans les contrôles de recherche.


- Résolution d’un problème qui entraînait des anomalies lors de l’utilisation de l’affichage compact.


- Correction d’un problème qui entraînait des blocages occasionnels lorsque les utilisateurs modifiaient les destinataires.


- Correction d’un problème qui empêchait l’affichage de la page de l’Assistant Planification chez certains utilisateurs.


- Correction d’un problème de performance lié au chargement de pièces jointes.
...
- Résolution d’un problème qui entraînait des blocages occasionnels lorsque les utilisateurs interagissaient avec des pièces jointes dans le cloud.
...
- Ce changement répond à un problème avec la fonction Exporter vers un GIF animé où le clic sur le bouton d'exportation n'entraînait pas d'exportation.
...
- Correction d’un problème qui entraînait un blocage lorsque les utilisateurs répondaient à un message ou en rédigeaient un nouveau.


- Cette modification corrige un problème à cause duquel les applications Office pouvaient rester bloquées à l’état d’échec d’enregistrement silencieux après une session de co-création.
...
- Correction de l’utilisation élevée de l’unité centrale avec les images GIF/modèles 3D animés lors de l’inactivité.
...
## <a name="version-2007-october-13"></a>Version 2007 : 13 octobre
...
- **Dites-le autrement :** la fonction Réécrire est là pour vous aider lorsque vous cherchez à vous exprimer autrement. La fonction Réécrire vous propose des solutions pour peaufiner vos phrases.<br />Consultez les détails dans le [billet de blog](https://blog-insider.office.com/2019/08/12/rewrite-in-word-say-it-another-way/)
...
- Résolution d’un problème qui provoquait la suppression de CustomUI XML pour un onglet de ruban personnalisé lors de l’enregistrement dans SharePoint/OneDrive.

- Résolution d’un problème qui peut entraîner le blocage d’Excel lorsque vous essayez d’insérer des tableaux croisés dynamiques dans une feuille de graphique.

### <a name="outlook"></a>Outlook

- Résolution d’un problème qui provoquait un blocage lors de l’envoi de commentaires à partir d’une notification d’administration.

- Résout un problème qui a entraîné la recherche d’une fonctionnalité dans suggérer une fonctionnalité de ne renvoyer aucun résultat et de laisser l’utilisateur sans option pour envoyer une nouvelle idée de fonctionnalité.

- Résolution d’un problème : Outlook invitait en permanence les utilisateurs à exécuter l’outil de réparation de la boîte de réception.

- Résolution d’un problème qui empêchait les utilisateurs des différentes versions de Windows 10 Server de voir le message d’avertissement « Statut de l’antivirus : non valide. Cette version de Windows prend en charge la détection antivirale, mais aucun virus n’a été détecté » alors qu’un antivirus était bien installé.

- Résolution d’un problème qui entraînait le blocage intermittent des utilisateurs dans certaines situations.
...
- Résolution d’un problème lié à l’événement de contrôle CLP pour l’étiquette répondre/transférer.
...
- Résolution d’un problème de blocage du volet de suggestions.
...
## <a name="version-2004-july-14"></a>Version 2004 : 14 juillet
*Version 2004 (Build 12730.20602)*

Mises à jour de sécurité répertoriées [ici](./microsoft365-apps-security-updates.md)

## <a name="version-2004-june-09"></a>Version 2004 : 09 juin
...
## <a name="version-2003-june-09"></a>Version 2003 : 09 juin
