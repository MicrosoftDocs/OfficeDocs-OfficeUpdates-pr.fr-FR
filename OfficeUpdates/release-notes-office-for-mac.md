...
> [!NOTE]
> - Si vous êtes abonné à Office Insider, consultez les [Notes de publication pour pour le canal bêta pour Mac](https://insider.office.com/releasenotes/mac/fast).
...
- **Ouvrir des boîtes aux lettres partagées et configurer la délégation :** Vous pouvez maintenant configurer des scénarios de délégation et ouvrir des boîtes aux lettres partagées dans le nouvel Outlook pour Mac.

- **L'éditeur offre des suggestions d'écriture en un seul clic :** Obtenez des suggestions d'orthographe, de grammaire et d'autres suggestions d'écriture intelligentes en un seul clic droit (Alt + Bas). Utilisez le clic gauche pour afficher le nouveau modèle de carte et découvrir d'autres options : Ajouter au dictionnaire, Afficher le contexte, Synonymes et plus encore. [En savoir plus](https://support.office.com/article/c6b1283d-81a2-47f1-bc85-9e8dfc0cbf15)

- **Dictez vos messages avec des commandes vocales :** La nouvelle barre d'outils de dictée, les commandes vocales et la ponctuation automatique permettent de composer des messages avec votre voix, rapidement et facilement.<br />Voir détails dans le [billet de blog](https://insider.office.com/fr-FR/blog)

- **Partager avec Microsoft Teams :** envoyer une copie des messages électroniques ou démarrer une conversation Teams liée à un courrier électronique spécifique. Lors du partage vers Team à partir d'Outlook pour Mac, une fenêtre popup s'affiche pour confirmer à quel canal ou à quelle personne vous voulez partager, vous pouvez également choisir si vous voulez inclure les pièces jointes ou non.
...
- **Personnaliser les applications dans Microsoft Teams :** La fonction de personnalisation des applications permet aux développeurs de spécifier que certaines propriétés de leurs applications Teams sont personnalisables et permet aux administrateurs informatiques de modifier l'une de ces propriétés dans le centre d'administration Teams. Par exemple, les administrateurs informatiques peuvent personnaliser le nom, la description et les icônes de l'application maintenant Virtual Agent de ServiceNow pour répondre aux besoins uniques de leur organisation.
...
-   [CVE-2021-31177](https://portal.msrc.microsoft.com/fr-FR/security-guidance/advisory/CVE-2021-31177)
...
- **Répéter vos présentations avec Assistant de présentation :** Assistant de présentation vous aide à répéter vos présentations afin de communiquer plus efficacement à votre audience. Il fournit des informations sur votre rythme, votre tonalité, l'utilisation de mots de remplissage et bien plus encore. [En savoir plus](https://support.office.com/article/cd7fc941-5c3b-498c-a225-83ef3f64f07b)<br />Voir détails dans le [billet de blog](https://insider.office.com/fr-FR/blog/presenter-coach-now-in-powerpoint-on-mac)
...
- **Le Rédacteur propose des suggestions d’écriture d’un simple clic :** obtenir des suggestions d&apos;écriture intelligente, grammaticales et orthographiques d’un simple clic (Alt + Bas). Utilisez le clic gauche pour afficher la nouvelle conception de carte et découvrir d’autres options qui s’offrent à vous : Ajouter au dictionnaire, Afficher le contexte, synonymes, etc.
...
-   [CVE-2021-28451](https://portal.msrc.microsoft.com/fr-FR/security-guidance/advisory/CVE-2021-28451)
-   [CVE-2021-28456](https://portal.msrc.microsoft.com/fr-FR/security-guidance/advisory/CVE-2021-28456)

### <a name="word"></a>Word

-   [CVE-2021-28453](https://portal.msrc.microsoft.com/fr-FR/security-guidance/advisory/CVE-2021-28453)
...
- **Dicter vos documents à l’aide des commandes vocales :** la nouvelle barre d’outils de dictée, les commandes vocales et la ponctuation automatique accélèrent et simplifient la création de contenu à l’aide de votre voix. [En savoir plus](https://support.office.com/article/3876e05f-3fcc-418f-b8ab-db7ce0d11d3c)
...
-   [CVE-2021-27054](https://portal.msrc.microsoft.com/fr-FR/security-guidance/advisory/CVE-2021-27054)
-   [CVE-2021-27057](https://portal.msrc.microsoft.com/fr-FR/security-guidance/advisory/CVE-2021-27057)
...
- **Appliquer automatiquement ou recommander des étiquettes de confidentialité :** Office peut recommander ou appliquer automatiquement une étiquette de confidentialité en fonction du contenu sensible détecté. [En savoir plus](/microsoft-365/compliance/apply-sensitivity-label-automatically)
...
## <a name="december-15-2020"></a>15 décembre 2020
...
- **Regarder vos formules:** Regardez les cellules sur plusieurs feuilles et livres dans un seul panneau ou fenêtre. [En savoir plus](https://support.office.com/article/d72fc6f3-4c9d-4c13-bd15-bb074ba7c784)

### <a name="powerpoint"></a>PowerPoint

- **Présenter votre diaporama dans une expérience à fenêtres :** Lecture de View vous permet d’être multi-tâche et ont plusieurs diaporamas à fenêtres.<br />Voir détails dans le [billet de blog](https://insider.office.com/fr-FR/blog/reading-view-available-in-powerpoint-for-mac)
...
-   [CVE-2020-17123](https://portal.msrc.microsoft.com/fr-FR/security-guidance/advisory/CVE-2020-17123)
-   [CVE-2020-17126](https://portal.msrc.microsoft.com/fr-FR/security-guidance/advisory/CVE-2020-17126)
-   [CVE-2020-17128](https://portal.msrc.microsoft.com/fr-FR/security-guidance/advisory/CVE-2020-17128)

### <a name="outlook"></a>Outlook

-   [CVE-2020-17119](https://portal.msrc.microsoft.com/fr-FR/security-guidance/advisory/CVE-2020-17119)

### <a name="powerpoint"></a>PowerPoint

-   [CVE-2020-17124](https://portal.msrc.microsoft.com/fr-FR/security-guidance/advisory/CVE-2020-17124)
...
- **La recherche est plus rapide et simple :** effectuer une recherche rapide dans votre fichier à l’aide de la zone de recherche
...
-   [CVE-2020-17067](https://portal.msrc.microsoft.com/fr-FR/security-guidance/advisory/CVE-2020-17067)
...
- **Actualisez les données à partir de Microsoft SQL Server :** actualisez vos requêtes Power Query sur Mac à partir de Microsoft SQL Server.

- **Créez des variables à utiliser dans les formules :** améliorez les performances, la lisibilité et la composabilité avec la fonction LET. Cette fonction vous permet de créer des variables nommées dans des formules nouvelles ou préexistantes. [En savoir plus](https://support.office.com/article/34842dd8-b92b-4d3f-b325-b8b8f9908999)<br />Voir détails dans le [billet de blog](https://insider.office.com/fr-FR/blog/let-names-in-formulas-for-excel)
...
- **Égayez vos classeurs :** donnez plus de style à votre feuille de calcul grâce aux images, icônes et autocollants stockés gratuits de qualité supérieure. Accédez à Insérer > Images > Images d’archives pour commencer. [En savoir plus](https://support.office.com/article/c7b78cdf-2503-4993-8664-851085c30fce)

### <a name="outlook"></a>Outlook

- **Découvrez le nouvel Outlook :** découvrez la nouvelle expérience sur l’ensemble du courrier, du calendrier, des contacts et des recherches. Vous profitez de performances améliorées, d’une plus grande simplicité et de nouvelles fonctionnalités attendues de longue date. [En savoir plus](https://support.office.com/article/6283be54-e74d-434e-babb-b70cefc77439)

### <a name="powerpoint"></a>PowerPoint

- **Égayez vos diapositives :** donnez plus de style à vos présentations grâce aux images, icônes et autocollants stockés gratuits de qualité supérieure. Accédez à Insérer > Images > Images d’archives pour commencer. [En savoir plus](https://support.office.com/article/c7b78cdf-2503-4993-8664-851085c30fce)

### <a name="powerpoint-mac"></a>PowerPoint Mac

- **Expérience améliorée avec les enregistrements audio :** l’expérience d’ajout de vos propres enregistrements audio a été simplifiée

### <a name="word"></a>Word

- **Égayez vos documents :** donnez plus de style à vos documents grâce aux images, icônes et autocollants stockés gratuits de qualité supérieure. Accédez à Insérer > Images > Images d’archives pour commencer. [En savoir plus](https://support.office.com/article/c7b78cdf-2503-4993-8664-851085c30fce)
...
-   [CVE-2020-16929](https://portal.msrc.microsoft.com/fr-FR/security-guidance/advisory/CVE-2020-16929)

### <a name="word"></a>Word

-   [CVE-2020-16933](https://portal.msrc.microsoft.com/fr-FR/security-guidance/advisory/CVE-2020-16933)

### <a name="office-suite"></a>Suite Office

-   [CVE-2020-16918](https://portal.msrc.microsoft.com/fr-FR/security-guidance/advisory/CVE-2020-16918)
...
- **Sécurité accrue pour les comptes Outlook.com :** les améliorations apportées à la sécurité signifient que vous n’avez plus besoin de créer un mot de passe d’application lorsque la vérification en deux étapes est activée pour votre compte Outlook.com.

### <a name="powerpoint-mac"></a>PowerPoint Mac

- **Dites-le avec des entrées manuscrites :** utilisez votre stylet numérique pour illustrer vos points lors de l’enregistrement d’une présentation et vos traits d’encre sont également enregistrés. [En savoir plus](https://support.office.com/article/0b9502c6-5f6c-40ae-b1e7-e47d8741161c)
...
- **Outlook sans les mains :** vous avez un micro ? Cliquez sur Dictée et observez Outlook saisir ce que vous dites. [En savoir plus](https://support.office.com/article/4010d238-bb25-45e9-89f6-8f9b54fcc0fc)
...
- **Rechercher dans le calendrier en mode hors connexion sur Outlook pour Mac** : vous pouvez désormais rechercher vos événements et rendez-vous dans votre Calendrier Outlook sur Mac lorsque vous êtes en mode hors connexion.
...
- **Étiquettes de confidentialité**: vous pouvez désormais appliquer une étiquette de confidentialité configurée par votre organisation pour vous inviter à entrer des autorisations personnalisées. [En savoir plus](/microsoft-365/compliance/encryption-sensitivity-labels?view=o365-worldwide#let-users-assign-permissions)
...
- **Actualiser les données des tables et des plages locales :** actualisez vos requêtes Power Query sur Mac à partir de tables et de plages locales.
...
- **Complément Excel Visualiseur de données Visio :** permet de visualiser rapidement et facilement vos données dans des diagrammes Visio soignés dans Excel.
...
|**Application**|**Mise à jour**|**Mises à jour de sécurité**|**Lien de téléchargement pour le package de mise à jour**|
|:-----|:-----|:-----|:-----|
|Outlook  <br/>| Résout un problème lié à la suppression des calendriers partagés ou délégués. [En savoir plus](https://support.office.com/article/42302f59-8325-4fab-aacb-13bbef855a0f)<br/>  | |[Package de mise à jour Outlook](https://officecdn.microsoft.com/pr/C1297A47-86C4-4C1F-97FA-950631F94777/MacAutoupdate/Microsoft_Outlook_16.23.19032603_Updater.pkg) <br/>|
...
|**Application**|**Mises à jour de fonctionnalité**|**Mises à jour de sécurité**|**Lien de téléchargement pour le package de mise à jour**|
|:-----|:-----|:-----|:-----|
|Mise à jour automatique Microsoft 4.9 <br/>| Corrections de bugs et améliorations apportées aux performances d’installation des mises à jour. <br/>|<br/> | [Package de mise à jour Microsoft AutoUpdate](https://officecdn.microsoft.com/pr/C1297A47-86C4-4C1F-97FA-950631F94777/MacAutoupdate/Microsoft_AutoUpdate_4.9.19030902_Updater.pkg)
...
|**Application**|**Mises à jour de fonctionnalité**|**Mises à jour de sécurité**|**Lien de téléchargement pour le package de mise à jour**|
|:-----|:-----|:-----|:-----|
|Word  <br/>| **Attirez leur attention avec mentions :** Utilisez @mentions dans des commentaires pour informer vos collègues que vous avez besoin de leur intervention. [En savoir plus](https://support.office.com/article/644bf689-31a0-4977-a4fb-afe01820c1fd)<br/><br/>**Modification des équations LaTex :** Word prend désormais en charge la syntaxe mathématique LaTeX pour créer et modifier des équations mathématiques. [En savoir plus](https://support.office.com/article/2e00618d-b1fd-49d8-8cb4-8d17f25754f8) | |[Package de mise à jour Word](https://officecdn.microsoft.com/pr/C1297A47-86C4-4C1F-97FA-950631F94777/MacAutoupdate/Microsoft_Word_16.23.19030902_Updater.pkg) <br/>|
|Excel  <br/>|**Attirez leur attention avec @Mentions :** Utilisez @mentions dans des commentaires pour informer vos collègues que vous avez besoin de leur intervention. [En savoir plus](https://support.office.com/article/644bf689-31a0-4977-a4fb-afe01820c1fd)  <br/><br/>**Apprenez-en davantage sur vos données :** le nouveau bouton Idées recherche des modèles dans vos données, et les utilise pour créer des suggestions intelligentes, personnalisées. [En savoir plus](https://support.office.com/article/3223aab8-f543-4fda-85ed-76bb0295ffc4) |  <br/>  |[Package de mise à jour Excel](https://officecdn.microsoft.com/pr/C1297A47-86C4-4C1F-97FA-950631F94777/MacAutoupdate//Microsoft_Excel_16.23.19030902_Updater.pkg) <br/>|
|PowerPoint  <br/>| **Meilleur ajustement de forme :** déplacez votre doigt sur le trackpad et regardez l’encre circuler sur l’écran. [En savoir plus](https://support.office.com/article/bc7f48ff-f152-4ee8-9081-d3121788024f) <br/><br/> | <br/>|[Package de mise à jour PowerPoint](https://officecdn.microsoft.com/pr/C1297A47-86C4-4C1F-97FA-950631F94777/MacAutoupdate/Microsoft_PowerPoint_16.23.19030902_Updater.pkg) <br/>|
|Outlook  <br/>|  <br/><br/>  ||[Package de mise à jour Outlook](https://officecdn.microsoft.com/pr/C1297A47-86C4-4C1F-97FA-950631F94777/MacAutoupdate/Microsoft_Outlook_16.23.19030902_Updater.pkg) <br/>|
...
|Suite Office <br/>|**Modifier rapidement l’image sélectionnée à partir du ruban à partir d’une autre source :** modifier l’image permet aux utilisateurs de modifier l’image ou le graphique sélectionné à partir de notre fonctionnalité image en ligne, de la bibliothèque d’icônes ou du presse-papiers. <br/>|<br/> | |
...
|**Application**|**Mises à jour de fonctionnalité**|**Mises à jour de sécurité**|**Lien de téléchargement pour le package de mise à jour**|
|:-----|:-----|:-----|:-----|
|Word  <br/>| Résolution d’un problème : il concernait la localisation en chinois.<br/><br/>**Franchissez la barrière de la langue :** traduisez des mots, des expressions ou tout un document dans une autre langue avec Microsoft Translator. Pour ce faire, utilisez l’onglet Révision du ruban.| |[Package de mise à jour Word](https://officecdn.microsoft.com/pr/C1297A47-86C4-4C1F-97FA-950631F94777/MacAutoupdate/Microsoft_Word_16.21.19011700_Updater.pkg) <br/>|
|Outlook  <br/>| Résolution d’un problème : il concernait la localisation en chinois.<br/><br/>**Optimiser la synchronisation en fonction de l’état du réseau et de l’alimentation :** Outlook optimise la synchronisation pour vos comptes Exchange lorsque vous êtes sur batterie et sur un réseau limité (par exemple, Wi-Fi de l’avion).<br/><br/>**Tous les détails de la réunion en un clin d’œil :** cliquez sur l’événement dans votre calendrier pour afficher tous les détails de la réunion. Découvrez qui y a été invité, modifiez votre réponse ou participez à la réunion à partir d’un emplacement unique. [En savoir plus](https://support.office.com/article/3b3b0575-36e2-4632-a982-1e6977870658)  | |[Package de mise à jour Outlook](https://officecdn.microsoft.com/pr/C1297A47-86C4-4C1F-97FA-950631F94777/MacAutoupdate/Microsoft_Outlook_16.21.19011700_Updater.pkg) <br/>|
...
> [!NOTE]
> À partir de la version 16.21, Microsoft Teams sera installé par défaut pour les ***nouvelles*** installations. Pour plus d’informations, consultez l’article [Installations de Microsoft Teams sur un Mac](/DeployOffice/teams-install#microsoft-teams-installations-on-a-mac).  
 ...
 *Version 16.19.0 (build 18110915)* 
...
|Suite Office  <br/>| |<br/>||
|Mise à jour automatique Microsoft 4.5 <br/>| – Prise en charge du Mode Sombre <br/> – Résolution de bogue pour un blocage de démon (mise à jour vers le SDK Aria 8.5.2.0) <br/>|<br/> | [Package de mise à jour Microsoft AutoUpdate](https://officecdn.microsoft.com/pr/C1297A47-86C4-4C1F-97FA-950631F94777/OfficeMac/Microsoft_AutoUpdate_4.5.18110402_Updater.pkg)|

## <a name="october-2018-release"></a>Version d’octobre 2018

 **Date de publication :** 16 octobre 2018 
  
 *Version 16.18.0 (build 18101400)* 
  
Cette version inclut les mises à jour suivantes :

|**Application**|**Mises à jour de fonctionnalité**|**Mises à jour de sécurité**|**Lien de téléchargement pour le package de mise à jour**|
|:-----|:-----|:-----|:-----|
|Word  <br/>|||[Package de mise à jour Word](https://officecdn.microsoft.com/pr/C1297A47-86C4-4C1F-97FA-950631F94777/OfficeMac/Microsoft_Word_16.18.18101400_Updater.pkg) <br/>|
 ...
 *Version 16.16.0 (build 18081201)* 
 ...
 *Version 16.15.0 (build 18070902)* 
  
Cette version inclut les mises à jour suivantes.
  
|**Application**|**Mises à jour des fonctionnalités**|**Mises à jour de sécurité**|**Lien de téléchargement pour le package de mise à jour**|
|:-----|:-----|:-----|:-----|
|Word  <br/> |||[Package de mise à jour Word](https://officecdn.microsoft.com/pr/C1297A47-86C4-4C1F-97FA-950631F94777/OfficeMac/Microsoft_Word_16.15.18070902_Updater.pkg) <br/>|
...
Cette version corrige un problème avec les paramètres liés aux données de diagnostic.
...
*Version 16.13.1 (build 18052203)* \*

Cette version inclut une notification destinée à l’utilisateur final, conformément au Règlement général sur la protection des données (RGPD).

\**Numéro de build pour Outlook : 18052301.* 
...
|OneNote  <br/> ||||
|Microsoft AutoUpdate 3.18  <br/> |Prise en charge de l’outil de ligne de commande msupdate. [En savoir plus](/DeployOffice/mac/update-office-for-mac-using-msupdate) <br/> ||||
 ...
 *Version 16.10.0 (build 18021001)* 
  
Cette version inclut les mises à jour suivantes.
  
|**Application**|**Mises à jour des fonctionnalités**|**Mises à jour non relatives à la sécurité**|
|:-----|:-----|:-----|
 ...
 *Version 16.9.1 (build 18012504)* 
  
Cette version corrige les problèmes de compatibilité dans Word et dans PowerPoint avec certaines polices tierces ou dans les environnements à plusieurs langages.

<br/><br/>  
  
 **Date de publication :** 18 janvier 2018 
  
 *Version 16.9.0 (build 18011602)* 
 ...
 **Date de publication :** 17 décembre 2017 
 ...
 Cette version corrige un problème avec la mise à jour automatique Microsoft (AutoUpdate), qui offrait une mise à jour de version incorrecte. 
 
<br/><br/>
 
 **Date de publication :** 12 décembre 2017 
  
 *Version 15.41.0 (build 17120500)* 
 ...
 *Version 15.40.0 (build 17110800)* 
 ...
 *Version 15.38.0 (build 17090200)* 
 ...
 *Version 15.37.0 (build 17081500)* 
...
|PowerPoint  <br/> |**Liens fiables :** lorsqu’un utilisateur clique sur un lien, la protection avancée contre les menaces d’Office 365 (ATP) inspecte le lien pour déterminer s’il est malveillant. Si le lien est considéré comme malveillant, l’utilisateur est redirigé vers une page d’avertissement au lieu de l’URL cible d’origine. [En savoir plus](https://support.office.com/article/dd6a1fef-ec4a-4cf4-a25a-bb591c5811e3)  |

   
## <a name="july-2017-release"></a>Version de juillet 2017


 **Date de publication :** 21 juillet 2017 
  
 *Version 15.36.1 (build 17072101)* 
  
Cette version corrige le problème dans Outlook lié à la mise à jour des messages de groupe. 
 ...
 *Version 15.35.0 (build 17061600)* 
  
Cette version corrige un problème où OneNote se bloque lorsque vous créez une page avec des modèles. 

<br/><br/>
  
 **Date de publication :** 13 juin 2017 
  
 *Version 15.35.0 (build 17061000)* 
...
## <a name="may-2017-release"></a>Version de mai 2017

 **Date de publication :** 16 mai 2017 
  
 *Version 15.34.0 (build 17051500)* 
 ...
 *Version 15.33.0 (build 17040900)* 
  
Cette version inclut les mises à jour suivantes.
  
|**Application**|**Mises à jour de fonctionnalité**|
|:-----|:-----|
|Microsoft AutoUpdate  <br/> | - Prise en charge des mises à jour de la suite Delta, qui réduit de moitié la taille de la mise à jour mensuelle.  <br/><br/>  - Prise en charge des mises à jour automatiques de Microsoft AutoUpdate, où cette fonction peut se mettre à jour automatiquement sans informations d’identification de l’administrateur.  <br/> |Cette version de Microsoft AutoUpdate n’est pas disponible en téléchargement.  <br/> |
   
## <a name="march-2017-release"></a>Version de mars 2017

 **Date de publication :** 14 mars 2017 
  
 *Version 15.32.0 (build 17030901)* 
  
Cette version inclut les mises à jour suivantes.
  
|**Application**|**Mises à jour de fonctionnalité**|**Mises à jour de sécurité**|
|:-----|:-----|:-----|
|Excel  <br/> ||Bulletin de sécurité Microsoft [MS17-014](/security-updates/SecurityBulletins/2017/ms17-014) : Mise à jour de sécurité pour Microsoft Office (3217868)   |
...
|Suite Office  <br/> ||Bulletin de sécurité Microsoft [MS17-014](/security-updates/SecurityBulletins/2017/ms17-014) : Mise à jour de sécurité pour Microsoft Office (3217868)  |
 ...
 *Version 15.31.0 (build 17021600)* 
...
|PowerPoint  <br/> |**Prise en charge de la Touch Bar :** les commandes les plus importantes en fonction de votre travail sont à portée de main. (Compatible uniquement avec les ordinateurs MacBook Pro dotés de la Touch Bar.)   |
|Microsoft AutoUpdate  <br/> ||Numéro de version mis à jour : 3.8.4. |
 ...
 *Version 15.30.0 (build 17010700)* 
