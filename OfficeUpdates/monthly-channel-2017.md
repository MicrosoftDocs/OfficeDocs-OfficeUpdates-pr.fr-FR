---
title: Notes de publication pour le canal mensuel versions 2017
ms.author: andrewmo
author: andymosten
manager: andrewmo
ms.date: 12/12/2017
...
ms.locfileid: "19556039"
---
# <a name="release-notes-for-monthly-channel-releases-in-2017"></a>Notes de publication pour le canal mensuel versions 2017

Ces notes de publication fournissent des informations sur les nouvelles fonctionnalités, des mises à jour de sécurité et des mises à jour de sécurité qui sont incluses dans les mises à jour tous les mois canal à Office 365 ProPlus 2017.
...
## <a name="version-1711-december-12"></a>Version 1711 : Décembre 12
...
## <a name="version-1711-december-6"></a>Version 1711 : Décembre 6
...
-   **Exporter au format 4K :** lorsque vous exportez une présentation au format vidéo, vous pouvez choisir l’option de résolution Ultra HD (4K).
...
## <a name="version-1710-november-27"></a>Version 1710 : Novembre 27
...
## <a name="version-1710-november-20"></a>Version 1710 : Novembre 20
...
## <a name="version-1710-november-14"></a>Version 1710 : Novembre 14
...
## <a name="version-1710-november-2"></a>Version 1710 : Novembre 2
...
### <a name="powerpoint-feature-updates"></a>PowerPoint : Mises à jour de fonctionnalité
-   **Crayon numérique :** Écrivez ou esquissez des idées avec notre nouvelle texture crayon. Une inclinaison suffit pour réaliser une trame avec les stylets numériques pris en charge.
-   **Publier sur Microsoft Stream :** Partagez une présentation sous forme de vidéo en toute sécurité au sein de votre organisation à l’aide de Microsoft Stream. [Plus d’informations](https://support.office.com/article/c140551f-cb37-4818-b5d4-3e30815c3e83?#bkmk_microsoftstream)
-   **Configuration des fonctionnalités LinkedIn :** Accédez à Fichier \> Options \> Général pour contrôler si les fonctionnalités LinkedIn apparaissent dans vos applications Office. [En savoir plus](https://support.office.com/article/dc81cc70-4d64-4755-9f1c-b9536e34d381)
...
### <a name="word-feature-updates"></a>Word : Mises à jour de fonctionnalité
-   **Microsoft Translator :** Traduisez des mots, des phrases ou l’intégralité d’un document dans une autre langue à l’aide de Microsoft Translator, un outil de Word. [Plus d’informations](https://support.office.com/article/24a987b3-03a1-4c17-8c1b-54495fca6b17)
-   **Crayon numérique :** Écrivez ou esquissez des idées avec notre nouvelle texture crayon. Une inclinaison suffit pour réaliser une trame avec les stylets numériques pris en charge.
...
## <a name="version-1709-october-25"></a>1709 version : Le 25 octobre
...
-   Résolution d’un problème : Word se bloque lorsqu’un utilisateur emploie l’option Enregistrer sous en spécifiant un document existant se trouvant dans OneDrive Entreprise, puis annule l’enregistrement ou tente de fusionner les modifications.
-   Résolution d’un problème : le fait de filtrer sur les champs de source de données contenant les valeurs null (vides) crée une erreur lorsque l’assistant de publipostage est en cours d’exécution.
-   Résolution d’un problème : lors de l’enregistrement d’un fichier synchronisé, Office ne parvient pas à écrire sur un disque, mais continue le chargement du fichier sur OneDrive. Avec ce correctif, un message d’erreur s’affiche désormais et le chargement cesse.



## <a name="version-1709-october-16"></a>Version 1709 : Octobre 16
...
## <a name="version-1708-october-4"></a>Version 1708 : Octobre 4
...
## <a name="version-1708-september-18"></a>Version 1708 : Septembre 18
...
### <a name="project-non-security-updates"></a>Project : Mises à jour non relatives à la sécurité
-   Résolution d’un problème : le début réel peut être effacé à tort lors de la définition du travail restant.
...
## <a name="version-1707-september-12"></a>Version 1707 : Septembre 12
...
## <a name="version-1707-august-29"></a>Version 1707 : Août 29
...
## <a name="version-1707-august-24"></a>Version 1707 : Août 24
...
## <a name="version-1707-august-18"></a>Version 1707 : Août 18
...
## <a name="version-1707-august-11"></a>Version 1707 : Août 11
...
## <a name="version-1707-august-7"></a>Version 1707 : Août 7
*Version 1707 (version 8326.2070)*

### <a name="skype-for-business-non-security-updates"></a>Skype Entreprise : Mises à jour non relatives à la sécurité
-   Résolution d’un problème : l’écran de connexion reste vide pour certaines langues (autres que l’anglais).



## <a name="version-1707-july-31"></a>Version 1707 : Juillet 31
*Version 1707 (version 8326.2062)*

### <a name="skype-for-business-non-security-updates"></a>Skype Entreprise : Mises à jour non relatives à la sécurité
-   Résolution d’un problème concernant le troncature des caractères non anglais dans une conversation et un historique de conversations.



## <a name="version-1707-july-28"></a>Version 1707 : Juillet 28
...
## <a name="version-1707-july-27"></a>Version 1707 : Juillet 27
...
-   **Enregistrement automatique :** Les modifications sont enregistrées automatiquement pour les classeurs stockés dans le nuage, et vous pouvez voir d’autres mises à jour en secondes. [Plus d’informations](https://support.office.com/article/6d6bd723-ebfd-4e40-b5f6-ae6e8088f7a5)
...
### <a name="powerpoint-feature-updates"></a>PowerPoint : Mises à jour de fonctionnalité
-   **Enregistrement automatique :** les modifications sont enregistrées automatiquement pour les présentations stockées dans le cloud. Vous pouvez voir les mises à jour apportées en quelques secondes. [Plus d’informations](https://support.office.com/article/6d6bd723-ebfd-4e40-b5f6-ae6e8088f7a5)
...
### <a name="project-non-security-updates"></a>Project : Mises à jour non relatives à la sécurité
-   Résolution d’un problème : le travail réel est incorrectement transféré vers une ressource d’entreprise lorsqu’il remplace une ressource locale et que le travail protégé est activé.
...
### <a name="word-feature-updates"></a>Word : Mises à jour de fonctionnalité
-   **Modification à l’aide des outils d’apprentissage :** les outils d’apprentissage sont désormais disponibles dans le mode web de Word. Ajustez l’espacement du texte et affichez les syllabes lors de la modification. Dans n’importe quelle vue, chaque mot mis en surbrillance apparaît lorsque le document est lu à haute voix. [Plus d’informations](https://support.office.com/article/a857949f-c91e-4c97-977c-a4efcaf9b3c1)
-   **Syntaxe LaTeX :** créez et modifiez des équations mathématiques utilisant la syntaxe LaTeX.
-   **Sons utiles améliorant l’accessibilité :** activez un indicateur sonore pour vous guider lors de votre tâche. Accédez à Fichier \> Options \> Options d’ergonomie. Aucun complément n’est nécessaire. [Plus d’informations](https://support.office.com/article/49fda9be-cce5-4c72-a87f-b11000197f5f)
-   **Emplacements des fichiers par compte :** lors de l’ouverture ou de l’enregistrement d’un fichier, la liste des emplacements est organisée selon le compte qui lui est associé.

### <a name="office-suite-non-security-updates"></a>Suite Office : Mises à jour non relatives à la sécurité
-   Ajout de la prise en charge de la version 64 bits de mscomctl.ocx, permettant aux utilisateurs de travailler dans les versions 64 bits d’Office pour créer, modifier et ouvrir des fichiers de macro contenant les contrôles courants.
-   Amélioration de l’accessibilité de contrôles utilisés dans mscomctl.ocx.



## <a name="version-1706-july-19"></a>Version 1706 : Juillet 19
...
### <a name="word-non-security-updates"></a>Word : Mises à jour non relatives à la sécurité
-   Résolution d’un problème : impossibilité de faire pivoter les formes dans la zone de dessin.
...
### <a name="office-suite-non-security-updates"></a>Suite Office : Mises à jour non relatives à la sécurité
-   Résolution d’un problème : commandes manquantes dans le ruban ou les boîtes de dialogue de personnalisation de la barre d’outils Accès rapide.



## <a name="version-1706-july-13"></a>Version 1706 : Juillet 13
...
## <a name="version-1706-june-28"></a>1706 version : Le 28 juin
...
### <a name="project-non-security-updates"></a>Project : Mises à jour non relatives à la sécurité
-   Résolution d’un problème où les valeurs de planification chronologiques ne correspondent pas aux valeurs initiales lorsque vous enregistrez un projet au format de fichier XML.
...
## <a name="version-1705-june-7"></a>Version 1705 : Le 7 juin
*Version 1705 (version 8201.2075)*

### <a name="excel-feature-updates"></a>Excel : Mises à jour de fonctionnalité
-   **Conserver la copie** : copiez vos cellules. Avant de les coller, vous pouvez toujours effectuer d’autres tâches telles que la saisie ou l’insertion de cellules.
...
## <a name="version-1704-june-1"></a>1704 version : Le 1er juin
...
## <a name="version-1704-may-18"></a>Version 1704 : Mai 18
...
-   **Messages exploitables :** Les développeurs peuvent créer des messages pour faciliter aux utilisateurs sans avoir à basculer vers un site web externe ou séparer App [plus d’informations](https://dev.office.com/blogs/create-more-engaging-conversations-with-new-actionable-messages-updates-announced-at-microsoft-build) de droite simple ou rapide des actions à partir d’Outlook
...
## <a name="version-1703-may-9"></a>Version 1703 : Mai 9
...
## <a name="version-1703-april-21"></a>Version 1703 : Avril 21
...
### <a name="excel-non-security-updates"></a>Excel : Mises à jour non relatives à la sécurité
-   Résolution d’un problème où les nouvelles fonctions qui ont été introduites après la publication d’Office 2016, par exemple TEXTJOIN, CONCAT, IFS, MAXIFS et MINIFS, sont manquantes.
...
### <a name="powerpoint-feature-updates"></a>PowerPoint : Mises à jour de fonctionnalité
-   **QuickStarter :** génère un plan automatiquement pour aider les utilisateurs débutants à rechercher un sujet de leur choix.[Plus d’informations](https://support.office.com/article/4784f273-0b2c-456c-9c89-24e5b977c224)
-   **Activité de fichier partagé :** cliquez sur le bouton Activité dans le coin supérieur droit du fichier pour voir à quel moment un fichier partagé dans OneDrive Entreprise ou SharePoint a été partagé, modifié, renommé ou restauré.
...
## <a name="version-1702-april-11"></a>Version 1702 : Avril 11
...
## <a name="version-1702-march-27"></a>1702 version : Le 27 mars
...
## <a name="version-1702-march-14"></a>Version 1702 : Mars 14
...
## <a name="version-1702-march-9"></a>1702 version : Le 9 mars
...
### <a name="powerpoint-feature-updates"></a>PowerPoint : Mises à jour de fonctionnalité
-   **Règle numérique :** sur les appareils qui possèdent un écran tactile, accédez à Dessin \> Règle, puis utilisez le stylet ou votre doigt pour dessiner des lignes droites ou pour aligner un ensemble d’objets. [Plus d’informations](https://support.office.com/article/6222c9b4-2fdf-48f7-a3fd-1687fbe2bf84)
-   **Suppression d’arrière-plan :** supprimez une image d’arrière-plan avec un outil de dessin au format libre.
...
-   Résolution du problème où les noms du créateur et du modificateur n’apparaissent pas lorsque vous pointez sur une annotation sur un tableau blanc.
...
### <a name="word-non-security-updates"></a>Word : Mises à jour non relatives à la sécurité
-   Résolution du problème où le positionnement vertical des nombres en exposant des notes de bas de page est incorrect.
-   Résolution du problème où le bouton de commande pour un complément ne fonctionne pas après la mise à niveau du complément ou après la suppression et le retéléchargement du complément sur l’Office Store.



## <a name="version-1701-february-23"></a>Version 1701 : Février 23
...
## <a name="version-1612-january-31"></a>1612 version : Le 31 janvier
...
## <a name="version-1612-january-25"></a>Version 1612 : Janvier 25
...
-   **Utiliser un stylet pour sélectionner et modifier des objets :** Prenez des objets par leur poignée avec un stylet numérique pour les redimensionner, les faire pivoter, les déplacer et bien plus encore.
-   **Sélection par lasso avec un bouton de stylet :** Utilisez les boutons de stylet numérique pris en charge pour sélectionner par lasso l’encre sans accéder au ruban.
...
## <a name="version-1611-january-4"></a>Version 1611 : Janvier 4
...
### <a name="excel-non-security-updates"></a>Excel : Mises à jour non relatives à la sécurité
-   Résolution d’un problème où des valeurs de cellule contenant du texte et des guillemets ne sont pas exportés correctement lorsque vous enregistrez le fichier au format CSV ou CSV UTF-8.
