...
-  Résout un problème dans Excel dans lequel la ligne en pointillés marquant la plage de cellules sélectionnées pour être copiées ne disparaît pas et reste dans le Presse-papiers, même après une opération utilisateur comme Coller. 

### <a name="outlook-non-security-updates"></a>Outlook : mises à jour non relatives à la sécurité
 - Résout un problème causant la disparition du lien « Cliquez ici pour afficher plus d’informations... » de la liste des résultats de recherche pour certains utilisateurs disposant de plusieurs comptes Exchange.
...
### <a name="lync-non-security-updates"></a>Lync : Mises à jour non relatives à la sécurité
 - Résout un problème empêchant l’affichage des émoticônes dans les messages instantanés. 
...
### <a name="excel-non-security-updates"></a>Excel : mises à jour non relatives à la sécurité
-   Résolution d’un problème : si votre langue d’édition est le japonais, le chinois ou le coréen, Excel peut se figer lorsque vous essayez de choisir une nouvelle police dans l’onglet Accueil ou pendant que vous modifiez.
...
### <a name="excel-non-security-updates"></a>Excel : mises à jour non relatives à la sécurité
-   Résolution d’un problème : la création par programme d’un tableau croisé dynamique suivie par une actualisation par programme entraînait le blocage d’Excel.
-   Résolution d’un problème : l’appel par programme de Workbook.Open() pouvait entraîner le blocage d’Excel.

### <a name="powerpoint-non-security-updates"></a>PowerPoint : mises à jour non relatives à la sécurité
-   Résolution d’un problème : la suppression des propriétés d’un document et des informations personnelles entraînait l’échec de l’enregistrement dans SharePoint.
