...
### <a name="access-feature-updates"></a>Access : mises à jour des fonctionnalités
 - **Visualisez vos données avec de nouveaux graphiques :** faites votre choix parmi 11 graphiques et ajoutez-en un à vos formulaires et rapports pour mieux visualiser les données et prendre vos décisions en connaissance de cause. [En savoir plus](https://support.office.com/article/1a463106-65d0-4dbb-9d66-4ecb737ea7f7)
 
 ### <a name="access-security-updates"></a>Access : mises à jour de sécurité
-   [CVE-2018-8312](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2018-8312) : Vulnérabilité d’exécution de code à distance Microsoft Access de type "Use After Free", utilisation de mémoire après sa libération

### <a name="excel-feature-updates"></a>Excel : mises à jour de fonctionnalité
 - **Modifications en collaboration :** Travaillez avec d’autres en même temps dans votre classeur. [En savoir plus](https://support.office.com/article/7152aa8b-b791-414c-a3bb-3024e46fb104)
 - **AutoSave pour les fichiers cloud est désormais activé par défaut :** AutoSave est activé par défaut dans la version du canal semi-annuel (ciblé) de septembre 2018. Cette modification signifie que les utilisateurs n'auront pas à craindre de perdre leurs modifications dans les documents stockés sur OneDrive ou SharePoint Online. Les modifications seront automatiquement enregistrées dans le cloud et les utilisateurs n'auront plus à appuyer explicitement sur Ctrl + S ou sur le bouton Enregistrer. Cependant, ils devront comprendre ce changement de comportement afin de ne pas modifier accidentellement les documents. Notez que les utilisateurs peuvent désactiver l'enregistrement automatique en utilisant la bascule AutoSave en haut de l'écran. Nous vous recommandons d’informer vos utilisateurs de ce changement à venir et de leur apprendre à tirer le meilleur parti de cette nouvelle fonctionnalité d’Office 365. [ En savoir plus sur AutoSave](https://support.office.com/article/What-is-AutoSave-6d6bd723-ebfd-4e40-b5f6-ae6e8088f7a5) [ En savoir plus sur ce que les administrateurs informatiques doivent savoir sur AutoSave](https://support.office.com/article/what-it-administrators-should-know-about-autosave-88e0f80f-e5ea-441b-9c5a-259f08490ae7)
- **Amélioration de la modification des cellules et de la barre de formule :** Vous pouvez maintenant utiliser CTRL + A pour sélectionner du texte dans une cellule ou dans la barre de formule. La prise en charge des emojis et autres caractères complexes a également été améliorée. [En savoir plus](https://support.office.com/article/1798d9d5-842a-42b8-9c99-9b7213f0040f)
- **Améliorations apportées au vérificateur d’accessibilité** : le vérificateur d’accessibilité a mis à jour la prise en charge des normes internationales et des recommandations pour rendre vos classeurs plus accessibles. [En savoir plus](https://support.office.com/article/a16f6de0-2f39-4a2b-8bd8-5ad801426c7f)
- **Évitez les modifications indésirables :** définissez vos classeurs pour qu’ils s’ouvrent en lecture seule afin d’éviter les modifications accidentelles. Sélectionnez Fichier> Informations> Protéger le classeur> Toujours ouvert en lecture seule
...
-   Résolution d'un problème : Excel peut se bloquer lors de la modification des données source d’un graphique à partir de son ensemble de cellules d'origine.
-   Résolution d'un problème : Le recalcul peut ne pas se produire à l'ouverture même si la propriété FullCalcOnLoad est définie.  
...
-   Résolution d’un problème : l'impression rapide d'un classeur Excel attaché à un courrier électronique Outlook peut ne pas s'imprimer.
...
### <a name="outlook-feature-updates"></a>Outlook : Mises à jour de fonctionnalité
 ...
 - **Gérer les profils à partir du sélecteur de profil :** Si vous utilisez le sélecteur de profil au démarrage d’Outlook, vous pouvez désormais apporter des modifications sans vous rendre au panneau de configuration. Créer et supprimer des profils, modifier les paramètres à partir du sélecteur de profil.
- **Accessibilité intégrée dans :** Rendez vos messages accessibles à tous en ajoutant un texte descriptif à vos images.
...
- **Affichage des participants aux réunions :** Vous pouvez voir les réponses d'autres personnes à une demande de réunion, même si vous n'êtes pas l'organisateur.
- **Ne ratez aucun rappel :** configurez les rappels pour qu’ils s’affichent dans une fenêtre contextuelle par-dessus les fenêtres sur lesquelles vous travaillez. Sinon, Outlook clignotera dans la barre des tâches pour attirer votre attention.[En savoir plus](https://support.office.com/article/7a992377-ca93-4ddd-a711-851ef3597925)
...
- **Afficher trois fuseaux horaires :** Besoin de planifier une réunion à travers les fuseaux horaires ? Ajoutez plusieurs fuseaux horaires à votre calendrier pour voir facilement la disponibilité de chacun et choisir une heure qui convient à tous. [En savoir plus](https://support.office.com/article/5ab3e10e-5a6c-46af-ab48-156fedf70c04)
- **Expérience utilisateur améliorée pour la création d'un groupe :** nous avons affiné l'expérience utilisateur pour créer un groupe afin de le rendre plus moderne et sans encombrement. [En savoir plus](https://support.office.com/article/04d0c9cf-6864-423c-a380-4fa858f27102)
...
-   [CVE-2018-8244](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2018-8244): Vulnérabilité d’élévation de privilèges Microsoft Outlook
...
-   Résolution d'un problème : Si vous changez la langue du système en japonais et tentez de taper des caractères japonais dans l'IDE VBA lorsqu'il est chargé dans Outlook, il se fige.
...
-   Résolution d’un problème : certains utilisateurs ne reçoivent pas les fonctionnalités de prise en charge qui ont été activées par leur administrateur client.

### <a name="powerpoint-feature-updates"></a>PowerPoint : Mises à jour de fonctionnalité 
- **AutoSave pour les fichiers cloud est désormais activé par défaut :** AutoSave est activé par défaut dans le canal semi-annuel (ciblé) de septembre 2018. Cette modification signifie que les utilisateurs n'auront pas à craindre de perdre leurs modifications dans les documents stockés sur OneDrive ou SharePoint Online. Les modifications seront automatiquement enregistrées dans le cloud et les utilisateurs n'auront plus à appuyer explicitement sur Ctrl + S ou sur le bouton Enregistrer. Cependant, ils devront comprendre ce changement de comportement afin de ne pas modifier accidentellement les présentations. Notez que les utilisateurs peuvent désactiver l'enregistrement automatique en utilisant la bascule AutoSave en haut de l'écran. Nous vous recommandons d’informer vos utilisateurs de ce changement à venir et de leur apprendre à tirer le meilleur parti de cette nouvelle fonctionnalité d’Office 365. [ En savoir plus sur AutoSave](https://support.office.com/article/What-is-AutoSave-6d6bd723-ebfd-4e40-b5f6-ae6e8088f7a5) [ En savoir plus sur ce que les administrateurs informatiques doivent savoir sur AutoSave](https://support.office.com/article/what-it-administrators-should-know-about-autosave-88e0f80f-e5ea-441b-9c5a-259f08490ae7)
- **Amélioration de la modification des cellules et de la barre de formule :** Vous pouvez maintenant utiliser CTRL + A pour sélectionner du texte dans une cellule ou dans la barre de formule. La prise en charge des emojis et autres caractères complexes a également été améliorée. [En savoir plus](https://support.office.com/article/1798d9d5-842a-42b8-9c99-9b7213f0040f)
- **Convertissez vos entrées manuscrites :** prenez des notes et dessinez des ébauches, puis convertissez-les en texte lisible et en formes nettes afin de créer une présentation soignée. [En savoir plus](https://support.office.com/article/8ca00db0-4342-4bde-bbb2-92d6cb5e2e45)
- **Prise en charge améliorée des SVG :** vous pouvez insérer des fichiers SVG auxquels sont appliqués des filtres. [En savoir plus](https://support.office.com/article/e2459f17-3996-4795-996e-b9a13486fa79)
- **Donnez un titre à vos diapositives avec un stylet :** utilisez votre stylet pour écrire un titre, puis laissez PowerPoint le convertir en texte. [En savoir plus](https://support.office.com/article/0740dec3-6291-4c1f-8baa-011d18449919)
- **Évitez les modifications indésirables :** définissez vos classeurs pour qu’ils s’ouvrent en lecture seule afin d’éviter les modifications accidentelles. Sélectionnez Fichier > Informations > Protéger le classeur > Toujours ouvrir en lecture seule
...
- **Sprint gestion :** Ajouter, mettre à jour ou supprimer de sprint agile rapidement.
...
- **Une nouvelle méthode pour gérer vos sprints :** optez pour une approche agile avec les tableaux des tâches. Allez à Gérer les sprints pour ajouter et supprimer des sprints à mesure de l’avancement de votre projet.
...
-   Résolution d’un problème lié à la prise en charge de TLS 1.2. (Remarque : il s’agit du même correctif qui a été mentionné dans les notes du 10 avril et mentionné ici à nouveau dans le cadre du cumul de septembre.)
...
- **Gardez votre diagramme et votre source synchronisés :** lorsque vous modifiez un diagramme du visualiseur de données dans Visio, vous pouvez mettre à jour les données sources Excel liées avec le contenu de diagramme le plus récentes.
- **Modèle visualiseur de données d’audit :** Importer du contenu à partir d’Excel et créer des diagrammes d’audit pour les transactions financières, gestion des stocks et bien plus encore.
- **Diagrammes d’initiation :** les modèles Organigramme, Brainstorming et SDL ont de nouveaux diagrammes d’initiation pour vous permettre d’être opérationnel rapidement.
...
- **AutoSave pour les fichiers cloud est désormais activé par défaut :** AutoSave est activé par défaut dans le canal semi-annuel (ciblé) de septembre 2018. Cette modification signifie que les utilisateurs n'auront pas à craindre de perdre leurs modifications dans les documents stockés sur OneDrive ou SharePoint Online. Les modifications seront automatiquement enregistrées dans le cloud et les utilisateurs n'auront plus à appuyer explicitement sur Ctrl + S ou sur le bouton Enregistrer. Cependant, ils devront comprendre ce changement de comportement afin de ne pas modifier accidentellement les présentations. Notez que les utilisateurs peuvent désactiver l'enregistrement automatique en utilisant la bascule AutoSave en haut de l'écran. Nous vous recommandons d’informer vos utilisateurs de ce changement à venir et de leur apprendre à tirer le meilleur parti de cette nouvelle fonctionnalité d’Office 365. ​[En savoir plus sur AutoSave](https://support.office.com/article/What-is-AutoSave-6d6bd723-ebfd-4e40-b5f6-ae6e8088f7a5) [En savoir plus sur ce que les administrateurs informatiques doivent savoir sur AutoSave]
- **Améliorations apportées au vérificateur d’accessibilité :** Le vérificateur d’accessibilité a mis à jour la prise en charge des normes internationales et des recommandations pour rendre vos messages plus accessibles. [En savoir plus](https://support.office.com/article/a16f6de0-2f39-4a2b-8bd8-5ad801426c7f)
- **Prise en charge améliorée des SVG :** vous pouvez insérer des fichiers SVG auxquels sont appliqués des filtres. [En savoir plus](https://support.office.com/article/e2459f17-3996-4795-996e-b9a13486fa79)
...
-   Résolution de certains problèmes de niveaux de performances.
...
-  Résout un problème rendant l’installation des mises à jour très lente dans certains scénarios.
-  Résolution d’un problème : à l’ouverture d’une application, l’utilisateur voit parfois apparaître un message de lancement en mode sans échec, puis l’application ne parvient pas à s’ouvrir.
-  Fixe certains problèmes de performances.
...
### <a name="excel-security-updates"></a>Excel : mises à jour de sécurité
-   [CVE-2018-8246](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2018-8246) : vulnérabilité de divulgation d’informations Microsoft Excel
-   [CVE-2018-8248](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2018-8248) : vulnérabilité de l’exécution de Code à distance de Microsoft Excel
...
### <a name="outlook-security-updates"></a>Outlook : mises à jour de sécurité
-   [CVE-2018-8150](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2018-8150) : Vulnérabilité de contournement de la fonctionnalité de sécurité de Microsoft Outlook
...
-   Résolution d’un problème : des références à des codes incorporés de YouTube basés sur Flash Player entraînaient l’ouverture d’une nouvelle fenêtre pour lire la vidéo. Les anciens codes incorporés sont désormais mis à niveau pour référencer les vidéos YouTube basées sur HTML5 afin qu’elles soient lues correctement.
-   Résolution d’un problème : lors de l’enregistrement d’un fichier synchronisé, Office ne parvient pas à écrire sur un disque, mais continue le chargement du fichier sur OneDrive. Avec ce correctif, un message d’erreur s’affiche désormais et le chargement ne s’effectue pas.
...
-   Ajoute une fonctionnalité permettant d’empêcher les mineurs d’acheter et d’activer des compléments Office provenant de l’Office Store.
