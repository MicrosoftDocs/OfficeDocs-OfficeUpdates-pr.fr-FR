...
## <a name="version-2008-june-08"></a>Version 2008 : 08 juin
...
- Nous avons résolu un problème où la barre d’état n’indiquait pas l’état Prêt pour certains utilisateurs.


### <a name="word"></a>Word

- Correction d’un problème où la numérotation et les retraits étaient perdus lors du collage de texte avec des styles personnalisés.


- Correction d’un problème qui supprimait la limite de taille des chaînes autorisées pour les contrôles de contenu.
...
- Correction d’un problème rare où l’ouverture de fichiers à partir de SharePoint Online pouvait être retardée inutilement par l’expiration des licences et de la gestion des droits numériques.



[//]: # (NE PAS SUPPRIMER LA FIN DU CONTENU BUGDETAILS)

## <a name="version-2002-june-08"></a>Version 2002 : 08 juin
...
- Nous avons apporté un correctif pour améliorer les performances lors du passage d'une feuille à l'autre ou du défilement avec le suivi du focus accessibilité activé.
...
- Correction d'un problème où certains fichiers ne pouvaient pas être exportés au format PDF.
...
- L’hôte Office a cessé de fonctionner dans Windows, lorsqu’un complément est activé alors que la clé de Registre HKEY_CURRENT_USER \Software\Microsoft\Internet Explorer\Main\TabProcGrowth est définie sur zéro. Cette modification résoudrait ce problème.
