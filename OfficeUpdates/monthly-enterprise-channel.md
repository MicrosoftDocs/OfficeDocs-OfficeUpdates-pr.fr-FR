...
## <a name="version-2104-june-08"></a>Version 2104 : 08 juin
...
- Résolution d’un problème où une restauration de build de version majeure pouvait entraîner l’arrêt de l’application lors de l’ouverture du fichier.
...
- Nous avons résolu un problème qui empêchait les utilisateurs des paramètres d’itinérance de répondre.


- Nous avons résolu un problème qui entraînait l’arrêt inattendu du processus lors de la recherche.


- Nous avons résolu une fermeture inattendue liée à la recherche.
...
- Correction d’un problème où une restauration de build de version majeure pouvait entraîner une fermeture inattendue lors de l’ouverture du fichier.
...
- Nous avons résolu un problème qui nécessitait une modification lors de la modification de l’objet OLE.


- Nous avons résolu un problème où certains textes sélectionnés n’étaient pas visibles lors de l’utilisation du thème sombre en mode lecture.


- Correction d’un problème qui pouvait entraîner la fermeture inattendue de Word lors de l’arrêt en raison de la déconnexion ou du redémarrage de l’ordinateur par l’utilisateur.


- Nous avons résolu un problème qui met à jour le texte de la légende d’enregistrement automatique pour les fichiers enregistrés localement.
...
- Correction d’un problème qui entraînait l’échec de l’ouverture du document cloud.
...
## <a name="version-2103-june-08"></a>Version 2103 : 08 juin
...
- Résolution d’un problème : Word, Powerpoint et Excel ne parviennent pas à ouvrir un document cloud en cas de restauration d’une build précédente
